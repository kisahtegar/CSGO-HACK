...
//signatures
constexpr ptrdiff_t dwClientState = 0x58BFC4;
...
constexpr ptrdiff_t model_ambient_min = 0x58F03C;
...
constexpr ptrdiff_t dwEntityList = 0x4DCEB7C;
constexpr ptrdiff_t dwForceAttack = 0x31FF054;
constexpr ptrdiff_t dwForceAttack2 = 0x31FF060;
constexpr ptrdiff_t dwForceBackward = 0x31FF0A8;
constexpr ptrdiff_t dwForceForward = 0x31FF09C;
constexpr ptrdiff_t dwForceJump = 0x52789F8;
constexpr ptrdiff_t dwForceLeft = 0x31FF0B4;
constexpr ptrdiff_t dwForceRight = 0x31FF0C0;
constexpr ptrdiff_t dwGameDir = 0x62A880;
constexpr ptrdiff_t dwGameRulesProxy = 0x52EBA5C;
constexpr ptrdiff_t dwGetAllClasses = 0xDDCF2C;
constexpr ptrdiff_t dwGlobalVars = 0x58BCC8;
constexpr ptrdiff_t dwGlowObjectManager = 0x5316E98;
constexpr ptrdiff_t dwInput = 0x5220150;
constexpr ptrdiff_t dwInterfaceLinkList = 0x966044;
constexpr ptrdiff_t dwLocalPlayer = 0xDB35EC;
constexpr ptrdiff_t dwMouseEnable = 0xDB92F8;
constexpr ptrdiff_t dwMouseEnablePtr = 0xDB92C8;
constexpr ptrdiff_t dwPlayerResource = 0x31FD3E0;
constexpr ptrdiff_t dwRadarBase = 0x52038F4;
constexpr ptrdiff_t dwSensitivity = 0xDB9194;
constexpr ptrdiff_t dwSensitivityPtr = 0xDB9168;
constexpr ptrdiff_t dwSetClanTag = 0x8A290;
constexpr ptrdiff_t dwViewMatrix = 0x4DC0494;
constexpr ptrdiff_t dwWeaponTable = 0x5220C18;
constexpr ptrdiff_t dwWeaponTableIndex = 0x326C;
constexpr ptrdiff_t dwYawPtr = 0xDB8F58;
constexpr ptrdiff_t dwZoomSensitivityRatioPtr = 0xDBEF60;
constexpr ptrdiff_t dwbSendPackets = 0xD93D2;
constexpr ptrdiff_t dwppDirect3DDevice9 = 0xA5050;
constexpr ptrdiff_t m_pStudioHdr = 0x2950;
constexpr ptrdiff_t m_yawClassPtr = 0xDB8F58;
constexpr ptrdiff_t m_pitchClassPtr = 0x5203B90;
...
constexpr ptrdiff_t r_model_ambient_min = 0x58F03C;
constexpr ptrdiff_t set_abs_angles = 0x1E51E0;
constexpr ptrdiff_t set_abs_origin = 0x1E5020;
constexpr ptrdiff_t is_c4_owner = 0x3C76A0;
constexpr ptrdiff_t force_update_spectator_glow = 0x3BA6CA;
constexpr ptrdiff_t anim_overlays = 0x2990;
constexpr ptrdiff_t m_flSpawnTime = 0x103C0;
constexpr ptrdiff_t find_hud_element = 0x524348A0;
